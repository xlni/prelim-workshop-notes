...
\usepackage{hyperref} %for interactive references
\usepackage{refstyle} %for newref
\usepackage{amsmath}
\usepackage{amsthm}
...
%\newenvironment{solution}[1][\unskip]{\paragraph{Solution {#1}:}}{\hfill$\square$} %old solution env
...
\newref{problem}{refcmd={\problemname~\ref{#1}}}
